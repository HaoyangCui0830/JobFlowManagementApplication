...
{
    public partial class TaskCheckItemComment : ContentPage
    {

        CheckItemCommentPageViewModel viewModel;

        public TaskCheckItemComment(int id, CommentViewModel comment)
        {
            Title = comment == null ? "Add Comment" : "Edit Comment";
            if (comment == null)
            {
                comment = new CommentViewModel();
            }
            viewModel = new CheckItemCommentPageViewModel(id, comment);
            InitializeComponent();
